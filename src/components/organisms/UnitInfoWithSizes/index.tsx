...
import { useSizesUnitManager } from 'hooks/useSizesUnitManager';
...
} & Extract<ProductDetailWithUniqueUnit, { tag: 'sizes' }>;

export const UnitInfoWithSizes: VFC<Props> = (props) => {
  const {
    // ユーザーが選んだunitId
    unitId,
    // ユーザーが選んだ個数
    ...
    inWishlist,
  } = useSizesUnitManager({ units: props.units, sizes: props.sizes });
