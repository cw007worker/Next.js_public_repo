...
import { ProductDetailWithDefaultUnit } from 'type/viewModel/productDetail';
import {
  GridItem,
  Heading,
  Text,
...
import { useDefaultUnitManager } from 'hooks/useDefaultUnitManger';
...
export const UnitInfoWithDefault: VFC<Props> = (props) => {
  const {
    // ユーザーが選んだunitId
    unitId,
    // ユーザーが選んだ個数
